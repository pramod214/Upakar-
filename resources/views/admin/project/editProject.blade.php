                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="{{route('updateProject',$project->id)}}" method="post" enctype="multipart/form-data" id="add_project">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('public/adminpanel/uploads/project/'.$project->image)}}" alt="" height="200px">
                                    </div>
